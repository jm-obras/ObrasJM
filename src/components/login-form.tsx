...
export function LoginForm({ embedded = false, onLoginSuccess }: LoginFormProps) {
  ...
  // When embedded (inside a modal), just render the card without full-screen wrapper
  if (embedded) {
    return cardContent
  }

  // Full-screen standalone login page
  return (
