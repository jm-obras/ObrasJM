...
-- ============================================================
-- 11. SEED DATA - SUBSECTORES
-- ============================================================

INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 1', 'TH-P1' FROM public.sectores WHERE codigo = 'TH';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 2', 'TH-P2' FROM public.sectores WHERE codigo = 'TH';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 3', 'TH-P3' FROM public.sectores WHERE codigo = 'TH';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 4', 'TH-P4' FROM public.sectores WHERE codigo = 'TH';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 5', 'TH-P5' FROM public.sectores WHERE codigo = 'TH';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 6', 'TH-P6' FROM public.sectores WHERE codigo = 'TH';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 7', 'TH-P7' FROM public.sectores WHERE codigo = 'TH';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 8', 'TH-P8' FROM public.sectores WHERE codigo = 'TH';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Sótano', 'TH-SO' FROM public.sectores WHERE codigo = 'TH';

INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 1', 'TC-P1' FROM public.sectores WHERE codigo = 'TC';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 2', 'TC-P2' FROM public.sectores WHERE codigo = 'TC';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 3', 'TC-P3' FROM public.sectores WHERE codigo = 'TC';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 4', 'TC-P4' FROM public.sectores WHERE codigo = 'TC';

INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 1', 'TA-P1' FROM public.sectores WHERE codigo = 'TA';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 2', 'TA-P2' FROM public.sectores WHERE codigo = 'TA';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 3', 'TA-P3' FROM public.sectores WHERE codigo = 'TA';

INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 1', 'T3-P1' FROM public.sectores WHERE codigo = 'T3';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Piso 2', 'T3-P2' FROM public.sectores WHERE codigo = 'T3';

INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Azoteas', 'A-PB-AZ' FROM public.sectores WHERE codigo = 'A-PB';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Emergencia', 'A-PB-EM' FROM public.sectores WHERE codigo = 'A-PB';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Triaje', 'A-PB-TR' FROM public.sectores WHERE codigo = 'A-PB';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'UTIP', 'A-PB-UTIP' FROM public.sectores WHERE codigo = 'A-PB';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Medicina Nuclear', 'A-PB-MN' FROM public.sectores WHERE codigo = 'A-PB';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Antiguo Triaje', 'A-PB-AT' FROM public.sectores WHERE codigo = 'A-PB';

INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Anatomía Patológica', 'A-S-AP' FROM public.sectores WHERE codigo = 'A-S';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Sala de Calderas', 'A-S-SC' FROM public.sectores WHERE codigo = 'A-S';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Desagües', 'A-S-DG' FROM public.sectores WHERE codigo = 'A-S';
INSERT INTO public.subsectores (sector_id, nombre, codigo) 
SELECT id, 'Almacén', 'A-S-AL' FROM public.sectores WHERE codigo = 'A-S';

-- ============================================================
-- 12. STORAGE BUCKET for evidence photos
-- ============================================================
