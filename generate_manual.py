...
def build_content():
    ...
    inst_data = [
        ...
        [Paragraph('Alcaldia del Municipio Libertador de Caracas', style_td_left), Paragraph('Alcaldia Caracas', style_td), Paragraph('Infraestructura civil y apoyo municipal', style_td_left)],
        [Paragraph('Alcaldia de Caracas (Gestion)', style_td_left), Paragraph('Alcaldia CCS', style_td), Paragraph('Gestion municipal y apoyo institucional', style_td_left)],
